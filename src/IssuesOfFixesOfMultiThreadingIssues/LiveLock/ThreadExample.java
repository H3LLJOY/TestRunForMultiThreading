...
public class ThreadExample {
    public static void main(String[] args) {
        ...
        Thread t1 = new Thread(new Reader(queue), "Thread_1");
        Thread t2 = new Thread(new Reader(queue), "Thread_2");
        Thread t3 = new Thread(new Reader(queue), "Thread_3");
        Thread t4 = new Thread(new Reader(queue), "Thread_4");
        Thread t5 = new Thread(new Reader(queue), "Thread_5");
        ...
        queue.add(new Equation(198,0)); // Will causeDivide by Zero ArithmeticException !!!
    ...
    private static class Reader implements Runnable {
        ...
        private void doWork(Equation eq) {
            double val = 0;
            try {
                val = ((double) eq.getDividend() / eq.getDivisor());
